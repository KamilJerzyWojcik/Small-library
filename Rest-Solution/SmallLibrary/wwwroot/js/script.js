...
function GetAllLend() {
    $.ajax({
        url: "http://rest-api-small-library.azurewebsites.net/api/lend",
        type: "Get"
...
function SetLendReaderButton(id) {
    ...
    button.addEventListener("click", function () {
        ...
        $.ajax({
            url: `http://rest-api-small-library.azurewebsites.net/api/lend/${id}`,
            type: "Delete"
        }).done(function () {
...
function SetAddReaderButton() {
    ...
    readerBookButton.addEventListener("click", function () {
        ...
        if (newReader.name !== "" && newReader.name != null && newReader.age !== 0 && newReader.age != null) {
            ...
            $.ajax({
                url: "http://rest-api-small-library.azurewebsites.net/api/readers",
                data: newReader,
                type: "POST"
            }).done(function (result) {
...
function SetDeleteReaderButton(reader) {
    ...
    button.addEventListener("click", function () {
        ...
        $.ajax({
            url: `http://rest-api-small-library.azurewebsites.net/api/readers/${reader.ID}`,
            type: "Delete"
        }).done(function () {
...
function EditReaderById(ID) {
    ...
    if (newReader.name !== "" && newReader.name != null && newReader.age !== 0 && newReader.age != null) {
        ...
        $.ajax({
            url: `http://rest-api-small-library.azurewebsites.net/api/readers/${newReader.id}`,
            data: newReader,
            type: "PUT"
        }).done(function () {
...
function GetAllBooks(borrowBook) {
    $.ajax({
        url: "http://rest-api-small-library.azurewebsites.net/api/books",
        type: "Get"
    }).done(function (result) {
...
function EditBookById(ID) {
    ...
    if (newBook.title !== "" && newBook.title != null && newBook.author !== "" && newBook.author != null) {
        ...
        $.ajax({
            url: `http://rest-api-small-library.azurewebsites.net/api/books/${newBook.id}`,
            data: newBook,
            type: "PUT"
        }).done(function () {
...
function SetDeleteButton(result) {
    ...
    button.addEventListener("click", function () {
        ...
        $.ajax({
            url: `http://rest-api-small-library.azurewebsites.net/api/books/${result.ID}`,
            type: "Delete"
        }).done(function () {
